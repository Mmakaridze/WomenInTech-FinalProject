...
let currentPage = 1;
let post = document.getElementById("vet-post");
...
.then (function (convertedJs) {
    convertedJs.data.forEach((item) => {
        let user = document.createElement("p");
        user.classList.add("post1-p");
        ...
        nameAvatarWraper.classList.add("postvet-div");
